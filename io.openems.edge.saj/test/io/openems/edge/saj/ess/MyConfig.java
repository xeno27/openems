...
public class MyConfig extends AbstractComponentConfig implements Config {
	...
	public static class Builder {
		...
		private int ratedPower = 50_000;
		private int capacity = 100_000;
		private int maxBatteryChargePower = 50_000;
		private int maxBatteryDischargePower = 50_000;
		private int minSoc = 10;
		private int maxSoc = 100;
		private int emsKeepTime = 60;
		...
		public Builder setEmsKeepTime(int emsKeepTime) {
			this.emsKeepTime = emsKeepTime;
			return this;
		}
	...
	@Override
	public int emsKeepTime() {
		return this.builder.emsKeepTime;
	}
}
