 ...
 *
 * <p>
 * The Growatt SPH inverters do not publish dynamic battery power limits via
 * Modbus, so the limits are derived from the nominal power and the configured
...
public final class AllowedPowerHandler {
	 ...
	 * @param maxChargePower    the nominal battery charge power in [W]; positive
	 * @param maxDischargePower the nominal battery discharge power in [W];
	 *                          positive
